...
<div class="container py-4">
    ...
    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        ...
        <div>
            ...
            <textarea name="product_desc" id="product_desc" rows="4" class="w-full border rounded p-2">{{ old('product_desc') }}</textarea>
        </div>
        ...
        <div>
            <label for="product_images" class="block font-medium">Gambar</label>
            <input type="file" name="product_images" id="product_images" class="block">
        </div>
