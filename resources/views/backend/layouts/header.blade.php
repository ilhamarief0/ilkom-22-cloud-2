                    ...
                    <li class="menu-item menu-item-open menu-item-here menu-item-submenu menu-item-rel menu-item-open menu-item-here menu-item-active" data-menu-toggle="click" aria-haspopup="true">
                        ...
                        <div class="menu-submenu menu-submenu-classic menu-submenu-left">
                            <ul class="menu-subnav">
                               ...
                               <li class="menu-item {{ request()->routeIs('tasks.*') ? 'menu-item-active' : '' }}" aria-haspopup="true">
    <a href="{{ route('tasks.index') }}" class="menu-link" aria-label="Task Manager" title="Lihat daftar tugas Anda">
        <span class="svg-icon menu-icon">
            <!-- SVG Icon: Compiling -->
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                <path opacity="0.3" fill="#000" d="M2.56 10.682l2.122-2.122a1.5 1.5 0 012.121 0l2.122 2.122a1.5 1.5 0 010 2.122l-2.122 2.122a1.5 1.5 0 01-2.121 0L2.56 12.804a1.5 1.5 0 010-2.122zM14.56 10.682l2.122-2.122a1.5 1.5 0 012.121 0l2.122 2.122a1.5 1.5 0 010 2.122l-2.122 2.122a1.5 1.5 0 01-2.121 0L14.56 12.804a1.5 1.5 0 010-2.122z"/>
                <path fill="#000" d="M8.561 16.682l2.122-2.121a1.5 1.5 0 012.121 0l2.122 2.121a1.5 1.5 0 010 2.122l-2.122 2.122a1.5 1.5 0 01-2.121 0L8.56 18.804a1.5 1.5 0 010-2.122zM8.561 4.682L10.683 2.56a1.5 1.5 0 012.121 0l2.122 2.122a1.5 1.5 0 010 2.121l-2.122 2.122a1.5 1.5 0 01-2.121 0L8.56 6.803a1.5 1.5 0 010-2.121z"/>
            </svg>
        </span>
