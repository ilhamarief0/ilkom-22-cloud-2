...
<div class="card card-custom card-stretch gutter-b">
    ...
    <div class="card-header border-0 py-5">
        ...
        <div class="card-toolbar">
            <a href="#" class="btn btn-info font-weight-bold font-size-sm mr-3">New Report</a>
            <a href="#" class="btn btn-danger font-weight-bold font-size-sm">Create</a>
        </div>
    </div>
    <!--end::Header-->
            ...
            <table class="table table-head-custom table-borderless table-vertical-center">
                <thead>
                    <tr class="text-left text-uppercase">
                        <th style="min-width: 250px;" class="pl-7">Products</th>
                    ...
                    @php
                        $agents = [
                            [
                                ...
                                'payment' => 'Paid',
                                'company' => 'Intertico',
                                'desc' => 'Web, UI/UX Design',
                                'rate' => 'Best Rated',
                            ],
                            [
                                'name' => 'Jessie Clarcson',
                                'tech' => 'C#, ASP.NET, MS SQL',
                                'avatar' => '018-girl-9.svg',
                                'earnings' => '$23,000,000',
                                'status' => 'Pending',
                                'commission' => '$1,600',
                                'payment' => 'Rejected',
                            ...
                            [
                                'name' => 'Lebron Wayde',
                                'tech' => 'PHP, Laravel, VueJS',
                                'avatar' => '047-girl-25.svg',
                                'earnings' => '$34,000,000',
                                'status' => 'Paid',
                                'commission' => '$6,700',
                                'payment' => 'Paid',
                            ...
                            [
                                'name' => 'Natali Trump',
                                'tech' => 'Python, PostgreSQL, ReactJS',
                                'avatar' => '014-girl-7.svg',
                                'earnings' => '$2,600,000',
                                'status' => 'Paid',
                                'commission' => '$14,000',
                                'payment' => 'Pending',
                        ...
                        <td class="pl-0 py-4">
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-50 symbol-light mr-4">
                                    <span class="symbol-label">
                                        <img src="{{ asset('assets/backend/media/svg/avatars/' . $agent['avatar']) }}" alt="{{ $agent['name'] }}" class="h-75 align-self-end" />
                                    </span>
                                </div>
                                <div>
                                    <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">{{ $agent['name'] }}</a>
                                    <span class="text-muted font-weight-bold d-block">{{ $agent['tech'] }}</span>
                                </div>
                            </div>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $agent['earnings'] }}</span>
                            <span class="text-muted font-weight-bold">{{ $agent['status'] }}</span>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $agent['commission'] }}</span>
                            <span class="text-muted font-weight-bold">{{ $agent['payment'] }}</span>
                        </td>
                        <td>
                            <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{ $agent['company'] }}</span>
                            <span class="text-muted font-weight-bold">{{ $agent['desc'] }}</span>
                        </td>
                        <td>
                            <img src="{{ asset('assets/backend/media/logos/stars.png') }}" alt="Rating Stars" style="width: 5.5rem" />
                            <span class="text-muted font-weight-bold d-block font-size-sm">{{ $agent['rate'] }}</span>
                        </td>
                        <td class="pr-0 text-right">
                            <a href="#" class="btn btn-light-success font-weight-bold font-size-sm">View Offer</a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
